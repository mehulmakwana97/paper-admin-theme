...
<!-- Mirrored from paper.kaijuthemes.com/layout-static-leftbar.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Mar 2016 10:00:55 GMT -->
<head>
    <meta charset="utf-8">
...
<header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
	...
	<div class="logo-area">
		<a class="navbar-brand navbar-brand-success" href="index-2.html">
	...
	<ul class="acc-menu">
		...
		<li><a  class="withripple" href="index-2.html"><span class="icon">
		...
		<li><a  class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">flash_on</i></span><span>Layout</span></a>
			<ul class="acc-menu">
				...
				<li><a  class="withripple" href="layout-static-leftbar.php">Static Sidebar</a></li>
				<li><a  class="withripple" href="layout-sidebar-scroll.html">Scroll Sidebar</a></li>
				<!-- <li><a  class="withripple" href="layout-horizontal.php">Horizontal Nav</a></li> -->
...
<li class="active"><a href="layout-static-leftbar.php">Static Leftbar</a></li>

                            </ol>
                            <div class="page-heading">            
                               
                               <h1>Static Leftbar</h1>
                           </div>
